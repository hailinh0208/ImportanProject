...
public class PrioritySerDes {
	...
	public static Map<String, String> toMap(Priority priority) {
		...
		if (priority.getDisplayPages() == null) {
			map.put("displayPageSingle", null);
		}
		else {
			map.put("displayPageSingle", String.valueOf(priority.getDisplayPages()));
		}
	...
	public static class PriorityJSONParser extends BaseJSONParser<Priority> {
		...
		protected boolean parseMaps(String jsonParserFieldName) {
			if (Objects.equals(jsonParserFieldName, "displayPageSingle")) {
				return false;
			}
		...
		protected void setField(
			...
			if (Objects.equals(jsonParserFieldName, "displayPageSingle")) {
				if (jsonParserFieldValue != null) {
					...
					DisplayPage[] displayPageSingleArray =
						new DisplayPage[jsonParserFieldValues.length];

					for (int i = 0; i < displayPageSingleArray.length; i++) {
						displayPageSingleArray[i] = DisplayPageSerDes.toDTO(
							(String)jsonParserFieldValues[i]);
					}

					priority.setDisplayPages(displayPageSingleArray);
				}
			}
			else if (Objects.equals(jsonParserFieldName, "id")) {
				if (jsonParserFieldValue != null) {
...
// LIFERAY-REST-BUILDER-HASH:2005493442