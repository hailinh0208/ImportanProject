...
public class Priority implements Serializable {
	...
	public DisplayPage[] getDisplayPages() {
		if (_displayPageSingleSupplier != null) {
			displayPageSingle = _displayPageSingleSupplier.get();

			_displayPageSingleSupplier = null;
		}
	...
	public void setDisplayPages(
		...
		_displayPageSingleSupplier = () -> {
			try {
				return displayPageSingleUnsafeSupplier.get();
			}
	...
	@JsonIgnore
	private Supplier<DisplayPage[]> _displayPageSingleSupplier;
	...
	public String toString() {
		...
		DisplayPage[] displayPageSingle = getDisplayPages();

		if (displayPageSingle != null) {
			if (sb.length() > 1) {
				sb.append(", ");
			}
			...
			for (int i = 0; i < displayPageSingle.length; i++) {
				sb.append(String.valueOf(displayPageSingle[i]));

				if ((i + 1) < displayPageSingle.length) {
					sb.append(", ");
				}
			}
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "cms.important.notification.dto.v1_0.Priority",
		name = "x-class-name"
	)
...
// LIFERAY-REST-BUILDER-HASH:1290527420