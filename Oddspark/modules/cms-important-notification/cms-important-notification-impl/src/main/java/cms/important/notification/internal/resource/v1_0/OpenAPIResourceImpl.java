...
@Generated("")
@OpenAPIDefinition(
	info = @Info(description = "CmsImportantNotification REST API", license = @License(name = "Apache 2.0", url = "http://www.apache.org/licenses/LICENSE-2.0.html"), title = "CmsImportantNotification", version = "v1.0")
)
@Path("/v1.0")
...
// LIFERAY-REST-BUILDER-HASH:-1660276222