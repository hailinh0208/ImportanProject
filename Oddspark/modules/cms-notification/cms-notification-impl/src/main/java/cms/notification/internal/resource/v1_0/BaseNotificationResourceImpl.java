...
public abstract class BaseNotificationResourceImpl
	 ...
	 *
	 * curl -X 'GET' 'http://localhost:8080/o/headless-api/v1.0/cms-regular-notification'  -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Operation(
		description = "Get latest regular notifications by competition type"
	)
	...
	@jakarta.ws.rs.GET
	@jakarta.ws.rs.Path("/cms-regular-notification")
	@jakarta.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	public RegularNotificationResponse getRegularNotification(
			@io.swagger.v3.oas.annotations.Parameter(hidden = true)
			@jakarta.ws.rs.QueryParam("competition")
			Integer competition,
			@io.swagger.v3.oas.annotations.Parameter(hidden = true)
			@jakarta.ws.rs.DefaultValue("3") @jakarta.ws.rs.QueryParam("limit")
			Integer limit)
		throws Exception {
