...
public class ImportantNotificationResponse implements Serializable {
	...
	public ImportantNotification[] getImportantNotifications() {
		if (_importantNotificationsSupplier != null) {
			importantNotifications = _importantNotificationsSupplier.get();

			_importantNotificationsSupplier = null;
		}
	...
	public void setImportantNotifications(
		...
		_importantNotificationsSupplier = () -> {
			try {
				return importantNotificationsUnsafeSupplier.get();
			}
	...
	@JsonIgnore
	private Supplier<ImportantNotification[]> _importantNotificationsSupplier;
	...
	public String toString() {
		...
		if (importantNotifications != null) {
			...
			for (int i = 0; i < importantNotifications.length; i++) {
				sb.append(String.valueOf(importantNotifications[i]));

				if ((i + 1) < importantNotifications.length) {
					sb.append(", ");
				}
			}
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "cms.notification.dto.v1_0.ImportantNotificationResponse",
		name = "x-class-name"
	)
...
// LIFERAY-REST-BUILDER-HASH:1011971636