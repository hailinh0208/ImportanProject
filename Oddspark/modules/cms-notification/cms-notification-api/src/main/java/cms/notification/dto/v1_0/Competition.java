...
@Generated("")
@GraphQLName(
	description = "Competition type of the notification", value = "Competition"
)
...
public class Competition implements Serializable {
	...
	public static Competition toDTO(String json) {
		return ObjectMapperUtil.readValue(Competition.class, json);
	}

	public static Competition unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(Competition.class, json);
	}
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "cms.notification.dto.v1_0.Competition",
		name = "x-class-name"
	)
...
// LIFERAY-REST-BUILDER-HASH:1283272924