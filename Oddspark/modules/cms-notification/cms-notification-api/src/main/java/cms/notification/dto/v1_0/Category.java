 ...
 */
@Generated("")
@GraphQLName(description = "Category of the notification", value = "Category")
...
public class Category implements Serializable {
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "cms.notification.dto.v1_0.Category",
		name = "x-class-name"
	)
...
// LIFERAY-REST-BUILDER-HASH:-1761857810